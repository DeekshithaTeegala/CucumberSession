...
public class Backgrounddemo {
	...
	public void i_am_on_the_homepage_of_demoweb() {
	...
	public void i_should_see_that_title_contains_demowebshop()  {
		assert driver.getTitle().contains("Demo Web Shop");
		driver.close();
	}

	@Then("^I should see that source contains demowebshop$")
	public void i_should_see_that_source_contains_demowebshop()  {
